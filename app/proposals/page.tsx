...
export default function ProposalsPage() {
  ...
  const fetchDetails = async (proposalId: string) => {
    ...
    if (data.success) {
      setDebates(prev => ({ ...prev, [proposalId]: data.debates }));
            ...
            return (
              <div key={p.proposal_id} className="card">
                <div
                  ...
                  onClick={() => fetchDetails(p.proposal_id)}
                >
                ...
                {isExpanded && (
                  <div className="mt-4 border-t border-[#30363d] pt-4 space-y-4">
                    ...
                    {proposalDebates.length > 0 && (
                      <div>
                        <h4 className="text-sm font-semibold mb-2">Debate</h4>
                            ...
                            <div key={i} className="bg-[#0d1117] rounded-lg p-3">
                              <div className="flex items-center gap-2 mb-1">
                                ...
                                <span
                                  ...
                                  style={{ color: STANCE_COLORS[d.stance] }}
                                >
                                  {d.stance}
                                </span>
